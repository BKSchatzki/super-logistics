                                ...
                                <div style="margin-left: 10px;">
                                    <?php
                                        ...
                                        if ( $status == 'incomplete' ) {
                                            $header_title = __( ' has re-open the task', 'super-logistics' );
                                        } else {
                                            $header_title = __( ' has completed the task', 'super-logistics' );
                                        }
                                    ?>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 80px;">
                                <p style="font-size: 16px; line-height: 30px; margin: 0; color: #7E8690;"><?php esc_html_e( 'Date', 'super-logistics' ); ?></p>
                                <p style="font-size: 16px; color: #000000; line-height: 30px; margin: 0;">
                                    <?php
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <div style="padding: 5px 15px; background: #edeef45e; border: 1px solid #f2f2f2; border-radius: 5px; margin-bottom: 30px; line-height: 26px; margin-top: 10px;">
                                    <?php echo empty( $description['html'] ) ? esc_html_e( 'No description found!', 'super-logistics' ) : wp_kses_data( $description['html'] ); ?>
                                </div>
                            </td>
                        </tr>
