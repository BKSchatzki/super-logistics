...
<template>
  <div id="add-new-mv">
    <button v-if="!isFormVisible" @click="showForm">Add Vendor</button>
    <form v-if="isFormVisible" id="new-vendor-form" @submit="addVendor">
      ...
      <button type="button" @click="clearFields">Cancel</button>
    </form>
  </div>
</template>
