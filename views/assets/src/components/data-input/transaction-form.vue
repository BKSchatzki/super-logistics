  ...
  methods: {
    ...
    setInitData() {
      ...
      try {
        ...
        this.transaction.items.crates.bol_count = this.initTrans.items.crates.bol_count;
        ...
        this.transaction.items.cartons.bol_count = this.initTrans.items.cartons.bol_count;
        ...
        this.transaction.items.skids.bol_count = this.initTrans.items.skids.bol_count;
        ...
        this.transaction.items.fiberCases.bol_count = this.initTrans.items.fiberCases.bol_count;
        ...
        this.transaction.items.carpets.bol_count = this.initTrans.items.carpets.bol_count;
        ...
        this.transaction.items.misc.bol_count = this.initTrans.items.misc.bol_count;
    ...
    <form class="btb" @submit.prevent>
      ...
      <div class="row">
        <items-section :read-only="readOnly"
                       :items="items"
                       :selected-show="transaction.show_id"
