...
const validationSchema = yup.object({
  ...
  total_pcs: yup
    .number()
    .nullable()
    .required("Total pieces are required")
    .moreThan(0, "Total pieces must be greater than 0"),
});
...
<template>
  <div class="flex flex-col gap-4">
    ...
    <Panel header="Shipping Labels">
      <div class="mb-8">
        <p>
          Please fill out the following form to print shipping labels. No
          account is necessary, only items received by the advance warehouse
          will be billed.
        </p>
      </div>
