...
const initialValues = ref({
  ...
  date_start: props.formData["date_start"]
    ? formatDateForJS(props.formData["date_start"])
    : new Date(),
  date_end: props.formData["date_end"]
    ? formatDateForJS(props.formData["date_end"])
    : new Date(),
});
  ...
  <Col>
    ...
    <Row>
      <ShowTextarea
        name="zones"
        label="Zones"
        placeholder="Enter zones here, separated by commas, no spaces."
      />
    </Row>
    <Row>
      <ShowTextarea
