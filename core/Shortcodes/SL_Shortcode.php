...
class SL_Shortcode {
     ...
     * @param array $atts
     */
	public static function output_internal( $atts = array() ) {
        if ( ! is_user_logged_in() ) {
            wp_login_form( array( 'echo' => true ) );

            return;
        }
		echo internal_root_element();
		self::scripts();
     ...
     * @param array $atts
     */
	public static function output_external( $atts = array() ) {
        if ( ! is_user_logged_in() ) {
            wp_login_form( array( 'echo' => true ) );

            return;
        }
		echo external_root_element();
		self::scripts();
